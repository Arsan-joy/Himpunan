...
/**
 * Ambil slug dari query (?slug=xxx) atau dari variabel $slug yang mungkin sudah di-set oleh wrapper (misal internal.php).
 * Default fallback 'internal' agar halaman tidak kosong.
 */
$slugParam = $_GET['slug'] ?? '';
...
$additional_css = ['internal.css']; // style khusus
$additional_js  = ['department.js','medkom-init.js']; // JANGAN tambah index.js (sudah dari header)
