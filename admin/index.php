...
<div class="admin-wrap">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a href="manage.php?m=leaders"><i class="fa-solid fa-user-tie"></i> Kelola Leader</a>
  ...
  <main class="main">
    ...
    <div class="grid">
      ...
      <div class="card metric"><div class="ico ico-green"><i class="fa-solid fa-user-tie"></i></div><div><div class="num"><?= $counts['Leader'] ?></div><div class="label">Leader</div></div></div>
